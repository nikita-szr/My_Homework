...
def testing_filter_by_currency_usd(transactions_for_test):
    result = list(filter_by_currency(transactions_for_test, "USD"))
    expected = [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
def testing_filter_by_currency_rub(transactions_for_test):
    result = list(filter_by_currency(transactions_for_test, "RUB"))
    expected = [
        {
            "id": 873106923,
            "state": "EXECUTED",
